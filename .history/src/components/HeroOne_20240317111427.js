...
export default function HeroOne() {
            ...
            <div className="container">
              <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                <div>
                  ...
                  <TypeAnimation
  sequence={[
    portfolioData.user.about.name.replace(
      /Jhon doe/i,
      '<span class="text-green-500">Jhon doe</span>'
    ),
    1000,
  ...
  wrapper="span"
  speed={50}
  className="typewrite text-amber-500 font-bold text-4xl lg:text-6xl"
  repeat={Infinity}
...
/>
                ...
                <div className="relative">
                 ...
                 <div className="absolute lg:bottom-20 md:bottom-10 bottom-2 ltr:md:-left-5 ltr:left-2 rtl:md:-right-5 rtl:right-2 p-4 rounded-lg shadow-md bg-gradient-to-r from-green-400 to-blue-500 m-3 w-44 text-center text-white">
  <span className="text-3xl font-bold mb-0">
  ...
  <h6 className="text-xs text-green-400 mt-1">Projects Completed</h6>
</div>
