...
<div
  style={{
    ...
    width: 0,
    height: 0,
    borderLeft: '100px solid transparent', // Half of the width
    borderRight: '100px solid transparent', // Half of the width
    borderBottom: '200px solid #fff', // Equal to the height
    transition: 'transform 0.3s',
  }}
></div>
