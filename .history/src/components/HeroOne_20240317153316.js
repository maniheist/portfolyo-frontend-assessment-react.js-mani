  ...
  return (
    <>
      {portfolioData.success === true && (
        <>
          <section
           className="relative pt-28 personal-wrapper overflow-hidden bg-bubbles"
      style={{
        backgroundImage: `radial-gradient(circle, #ffeb3b 10%, transparent 10%),
                          radial-gradient(circle, #f44336 10%, transparent 10%),
                          radial-gradient(circle, #2196f3 10%, transparent 10%),
                          radial-gradient(circle, #4caf50 10%, transparent 10%)`,
        backgroundSize: '30px 30px', // Adjust the size of the bubbles
        backgroundPosition: '0 0, 0 0, 15px 15px, 15px 15px', // Offset the bubbles
      }}
            id="home"
          >
