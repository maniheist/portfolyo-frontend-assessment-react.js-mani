...
export default function AboutUs() {
  ...
  className="rounded-lg shadow-md shadow-gray-200 dark:shadow-gray-800"
  alt=""
  style={{
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {/* Remove the following line to not display the sequence numbers */}
                       <p className="text-gray-500 text-sm">Sequence: {item.sequence}, Percentage: {item.percentage}%</p> 
                    </div>
                  </div>
                );
              })}
