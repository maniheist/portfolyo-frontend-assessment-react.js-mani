        ...
        <section className="bg-gradient-to-r from-blue-200 to-blue-400 dark:bg-slate-800 py-16 md:py-24" id="contact">
          <div className="container">
            <div className="text-center">
              ...
              <p className="text-white text-lg md:text-xl">{portfolioData.user.about.subTitle}</p>
              <p className="text-white text-lg md:text-xl mb-8">{portfolioData.user.about.quote}</p>
            </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-md shadow-md p-6">
                <div className="mb-8">
                  <div className="flex items-center mb-4">
                    ...
                    <p className="ml-4 text-white">{portfolioData.user.about.phoneNumber}</p>
                  </div>
                  <div className="flex items-center mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="ml-4 text-white">{portfolioData.user.about.address}</p>
                  </div>
                </div>
