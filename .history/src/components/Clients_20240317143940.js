          ...
          <div className="container">
            ...
            <Slider {...settings}>
              {portfolioData.user.testimonials.map((item) => (
                <div key={item._id} className="px-4 h-full">
                  <div className="customer-testimonial h-full">
                    <div className="content relative rounded shadow-md bg-white dark:bg-slate-900 h-full flex flex-col justify-between">
