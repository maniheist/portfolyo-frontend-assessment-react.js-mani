...
export default function GetInTouch() {
  ...
  <div className="icons text-center mx-auto">
    <Unicons.UilPhone className="block rounded text-2xl dark:text-white mb-0 transition-transform duration-300 transform hover:scale-110" />
  </div>
  ...
  <div className="flex-1 ms-6">
    ...
    >
      {portfolioData.user.about.phoneNumber}
                  ...
                  <div className="flex mt-4">
                    <div className="icons text-center mx-auto">
                      <Unicons.UilMapMarker className="block rounded text-2xl text-orange-500 dark:text-orange-400 mb-0 transition-transform duration-300 transform hover:scale-110" />
                    </div>
