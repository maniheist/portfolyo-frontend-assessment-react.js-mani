...
/>
                ...
                <div className="relative">
                  ...
                  <div className="absolute lg:bottom-20 md:bottom-10 bottom-2 ltr:md:-left-5 ltr:left-2 rtl:md:-right-5 rtl:right-2 p-4 rounded-lg shadow-md bg-green-500 m-3 w-44 text-center text-white">
