...
export default function AboutUs() {
  ...
  <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
    {portfolioData.user.skills
      ...
      .map((item, index) => {
        return (
          <div
  className="flex group shadow-lg dark:shadow-xl hover:shadow-xl transition-shadow duration-300 items-center p-3 rounded-lg bg-white dark:bg-slate-900 transform hover:scale-105"
            key={index}
          >
  ...
  <p className="text-gray-500 text-sm mt-1">{item.percentage}%</p>
</div>
