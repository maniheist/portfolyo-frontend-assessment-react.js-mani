...
// Add CSS classes for gradient overlay and hover effect
// Add CSS for animation and other styles
                ...
                {portfolioData.user.projects.map((item, index) => {
                  return (
                    ...
                    >
                      ...
                      <div className="project-details absolute bottom-0 left-0 right-0 top-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
                        <Link2
                          to="#!"
