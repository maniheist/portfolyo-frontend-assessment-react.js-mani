              ...
              <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-8">
                <div>
                  ...
                  <div className="flex">
                    <Link
                      to=""
                      className="btn bg-yellow-500 hover:bg-yellow-600 text-white rounded-md mr-4"
                    >
                      Hire Me
                    </Link>
                    <Link
                      to=""
                      className="btn bg-yellow-200 hover:bg-yellow-300 text-yellow-500 hover:text-white rounded-md"
                    >
                      Download CV
                    </Link>
                  </div>
