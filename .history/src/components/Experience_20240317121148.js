      ...
      {portfolioData.success === true && (
        <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="experience">
          <div className="container">
            ...
            <div className="grid grid-cols-1 mt-8 gap-8 relative">
              {portfolioData.user.timeline.map((item, index) => {
                ...
                return (
                  <div key={item._id} className="relative">
                    ...
                    {index !== portfolioData.user.timeline.length - 1 && (
                      <div className="absolute left-1/2 top-0 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-amber-500 to-amber-300"></div>
                    )}
                  </div>
                );
              })}
