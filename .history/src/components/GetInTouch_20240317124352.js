        ...
        <section className="bg-gradient-to-r from-blue-200 to-blue-400 dark:bg-slate-800 py-16 md:py-24" id="contact">
          <div className="container">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-xl mx-auto text-sm md:text-base">{portfolioData.user.about.quote}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-md shadow-md p-6">
               ...
               <br/>
  <a href="#service" className="btn bg-amber-500 hover:bg-amber-600 text-white rounded-md py-2 px-6">
    Explore Services
  </a>
</div>
<div className="flex justify-center">
  <a href="#about" className="btn bg-amber-500 hover:bg-amber-600 text-white rounded-md py-2 px-6">
    Skills
  </a>
</div>
              </div>
